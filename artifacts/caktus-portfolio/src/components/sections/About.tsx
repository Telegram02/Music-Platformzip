...
export function About() {
  ...
  const showPhoto = photoUrl && photoVisible;
          ...
          >
            <div className="relative">
              <div className="aspect-square max-w-md mx-auto lg:mx-0 bg-card border border-border/50 rounded-sm relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 to-accent/20 opacity-50 mix-blend-overlay group-hover:opacity-100 transition-opacity duration-700 z-10" />
