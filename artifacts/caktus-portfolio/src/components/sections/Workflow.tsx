...
export function Workflow() {
  return (
    <section id="workflow" className="py-32 relative bg-background">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-6">
            {steps.map((step, index) => (
              ...
              >
                {/* Number Circle */}
                <div className="absolute left-0 lg:static lg:mb-6 w-[60px] h-[60px] lg:w-[90px] lg:h-[90px] rounded-full bg-card border border-border flex items-center justify-center z-10 shadow-[0_0_15px_rgba(0,0,0,0.5)] group-hover:border-primary transition-colors">
